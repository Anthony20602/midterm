...
<Package name="EX05_TabletWebpage" format_version="4">
    ...
    <Dialogs>
        ...
        <Dialog name="English_Dialog" src="English_Dialog/English_Dialog.dlg" />
    </Dialogs>
    <Resources>
        ...
        <File name="English_Flag" src="html/pics/English_Flag.jpg" />
        <File name="HelloRobot(En)" src="html/pics/HelloRobot(En).png" />
        <File name="QRCodeImage" src="html/pics/QRCodeImage.jpg" />
        <File name="QRCodeRobot" src="html/pics/QRCodeRobot.png" />
        <File name="UsekCampus" src="html/pics/UsekCampus.jpg" />
        <File name="Useknlogo" src="html/pics/Useknlogo.jpg" />
        <File name="french_flag" src="html/pics/french_flag.png" />
        <File name="useklogo2" src="html/pics/useklogo2.png" />
    </Resources>
    <Topics>
        <Topic name="confirmation_enu" src="confirmation/confirmation_enu.top" topicName="confirmation" language="en_US" />
        <Topic name="English_Dialog_enu" src="English_Dialog/English_Dialog_enu.top" topicName="English_Dialog" language="en_US" />
    </Topics>
    <IgnoredPaths />
